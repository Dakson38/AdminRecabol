...
import vermasIcon from '../assets/icons/vermas_icon.svg'
...
const DataListaTrabajos = ({ dataTrabajos }) => {
    const [data, setData] = useState(dataTrabajos)
    ...
    const columns = [
        ...
        },
        {
            ...
            header: () => <span>Cotizacion (Bs.)</span>
        },
        {
            accessorKey: 'estado',
            ...
            cell: info => {
                return (
                    <span className={classNames({
                        ...
                        'bg-red-500': 'PENDIENTE' === info.getValue(),
                        'bg-green-500': 'FINALIZADO' === info.getValue()
                    })}>
                        {info.getValue()}
                    </span>
                )
        ...
        },
        {
            ...
            cell: info => {
                return (
                    <button><img src={vermasIcon} alt="" /></button>
                )
            },
            enableSorting: false
        }
...
export default DataListaTrabajos